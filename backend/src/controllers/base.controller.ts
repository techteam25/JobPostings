...
export class BaseController {
  ...
  protected handleControllerError(
    ...
    if (error.name === 'ValidationError' || error.name === 'ZodError') {
      ...
      return this.sendError(res, validationError, process.env.NODE_ENV === 'development');
    }

    // Handle database errors
    if (error.code && (error.code.includes('ER_') || error.code.includes('SQLITE_'))) {
      ...
      return this.sendError(res, dbError, process.env.NODE_ENV === 'development');
    }
    ...
    return this.sendError(res, genericError, process.env.NODE_ENV === 'development');
  }
  ...
  protected sanitizeOutput(data: any, fieldsToRemove: string[] = ['passwordHash', 'password']): any {
